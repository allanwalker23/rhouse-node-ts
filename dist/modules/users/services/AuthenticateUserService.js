...
var AuthenticateUserService = /** @class */ (function () {
    ...
    AuthenticateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, passwordHashed, passwordDatabase, _b, secret, expiresIn, token;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new AppError_1.default('Oops! Seu email ou senha está incorreto', 401);
                        }
                        return [4 /*yield*/, this.hashProvider.generateHash(senha)];
                    case 2:
                        passwordHashed = _c.sent();
                        return [4 /*yield*/, this.userRepository.comparePassword(senha, passwordHashed)];
                    case 3:
                        passwordDatabase = _c.sent();
                        if (!passwordDatabase) {
                            throw new AppError_1.default('Oops! Seu email ou senha está incorreto', 401);
                        }
